...
>_Слова в [ссылке](https://ru.wikipedia.org/wiki/%D0%A1%D1%81%D1%8B%D0%BB%D0%BA%D0%B0_(%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D1%8C) "Ссылка (запись) — Википедия") должны подчиняться правилам русского языка, капс не позволителен (исключение — аббревиатуры)
