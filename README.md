...
![КДПВ](https://slasher.ru/articles/link-or-button/+poster.png)
...
[ссылки](https://ru.wikipedia.org/wiki/%D0%A1%D1%81%D1%8B%D0%BB%D0%BA%D0%B0_(%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D1%8C) "Ссылка (запись) — Википедия")
— не комильфо.
...
**— это [ссылка](https://ru.wikipedia.org/wiki/%D0%A1%D1%81%D1%8B%D0%BB%D0%BA%D0%B0_(%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D1%8C) "Ссылка (запись) — Википедия")**.
...
```
Когда курсор находится над [ссылкой](https://ru.wikipedia.org/wiki/%D0%A1%D1%81%D1%8B%D0%BB%D0%BA%D0%B0_(%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D1%8C) "Ссылка (запись) — Википедия"), она становится `:hover` и в данном примере приобретает подчёркивание. Так пользователь поймёт, что это *точно* [ссылка](https://ru.wikipedia.org/wiki/%D0%A1%D1%81%D1%8B%D0%BB%D0%BA%D0%B0_(%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D1%8C) "Ссылка (запись) — Википедия"), на которую можно кликнуть.
...
`<button>` по умолчанию имеет атрибут `type=sumbit` даже если его не прописать.
...
`type=summit` в остальных местах ни на, что не влияет.
...
>```html
><button>
>   <img src="/images/icon.svg" title="Отправить" alt="Иконка" />
...
[GitHub](https://github.com/KasperGreen/button-or-link-guide-ru)
